...
[![GoDoc](https://godoc.org/github.com/MarkSG93/rtmp?status.svg)](https://godoc.org/github.com/MarkSG93/rtmp)
...
```
go get github.com/MarkSG93/rtmp
```
...
of the RTMP specification. For example, the client knows how to:
  ...
  * Handshake itself by using the `github.com/MarkSG93/rtmp/handshake` package
  * Receive RTMP control sequences using the `github.com/MarkSG93/rtmp/control`
    package
  * More to come...

For more information on all of the things that the client can do, see the
[relevant
documentation](https://godoc.org/github.com/MarkSG93/rtmp/client#Client).
